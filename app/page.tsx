...
const teamMembers: TeamMember[] = [
  {
    ...
    department: '정보보호학과',
    introduction:
      '안녕하세요. 23학년 2학년 고은이입니다. 웹 서버 보안 프로그래밍 수업을 통해 nextjs에 대해 배우고  웹 서비스를 제공하는 웹 사이트를 제작하는 것을 배우고 있습니다. 웹 이외에는 포렌식에 관심을 가지고 공부하고 있습니다.',
    ...
    >
      <div className="flex items-start mb-4">
        <img
          src={member.image}
          alt={member.name}
          className="w-24 h-24 rounded-full mr-4 -mt-10 -ml-10 border-4 border-white cursor-pointer" // 사진 클릭 시 원본 보기
      ...
      {showLinks && (
        <div className="absolute bottom-2 left-6 bg-gray-100 p-2 rounded">
          <a
            href={member.github}
            target="_blank"
